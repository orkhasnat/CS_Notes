...
- [[Awesome Privacy (Outdated)#Video Conferencing|Video Conferencing ]]
- [[Awesome Privacy (Outdated)#Email|Email]]
- [[Awesome Privacy (Outdated)#Distributed web|Distributed web]]
- [[Awesome Privacy (Outdated)#Web Browsers|Web Browsers]]
- [[Awesome Privacy (Outdated)#Web Browser Extensions|Web Browser Extensions]]
- [[Awesome Privacy (Outdated)#Other browser settings|Other browser settings]]
- [[Awesome Privacy (Outdated)#Storage|Storage]]
- [[Awesome Privacy (Outdated)#VPN|VPN]]
- [[Awesome Privacy (Outdated)#Android ROMs|Android ROMs]]
- [[Awesome Privacy (Outdated)#Android Apps|Android Apps]]
- [[Awesome Privacy (Outdated)#Password managers|Password managers]]
- [[Awesome Privacy (Outdated)#Hosting|Hosting]]
- [[Awesome Privacy (Outdated)#Pastebin|Pastebin]]
- [[Awesome Privacy (Outdated)#Other|Other]]
- [[Awesome Privacy (Outdated)#Linux Tools|Linux Tools]]
- [[Awesome Privacy (Outdated)#Related awesome lists|Related awesome lists]]
...
## Social Media
- [mastodon](https://mastodon.social/) - decentralized facebook twitter hybrid app
- [minds](https://www.minds.com/)  
- [disporia](https://diasporafoundation.org) 
- [hive](https://hive.blog/) - blockchain social media platform - blogging - you can earn crypto-currency for your content
...
## Distributed web
- [zeronet](https://zeronet.io/) - decentralized internet and web hosting
...
- [Brave](https://brave.com/) - Really nice browser for normies, doesn't need configuration
...
- [WebApps](https://f-droid.org/en/packages/com.tobykurien.webapps/) - turns web app sites into secure apps
...
- [Tor](https://guardianproject.info/apps/org.torproject.torbrowser/) - private browser that anonymous and encrypts traffic through tor network
- [Orbit](https://guardianproject.info/apps/orbot/) - encrypt and anonymous internet traffic through tor
- [New Pipe](https://f-droid.org/en/packages/org.schabi.newpipe/) - ad-free lightweight youtube app
